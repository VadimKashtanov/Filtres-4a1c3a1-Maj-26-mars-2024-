...
#define SCORE_AVEC_USD_NORME /*true*/false

#define L2_regularisation +3e-6
...
#define K_fonc(x) ((powf(x,0.25)+powf(x,1.0)+powf(x,2.0))/3)
...
//#define K(p1,p0,alea) (powf(fabs(100*(p1/p0-1)), 0.25) + powf(fabs(100*(p1/p0-1)), 2.0))
#define K(p1,p0,alea) K_fonc(fabs((100+10*alea/(SCORE_Y_COEF_BRUIT>0?SCORE_Y_COEF_BRUIT:1.0))*(p1/p0 - 1)))
